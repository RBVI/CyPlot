...
public class DotPlotColumnTaskFactory extends AbstractTableColumnTaskFactory {
//	final CyChartManager manager;
	final CyServiceRegistrar cs_registrar;
	
	public DotPlotColumnTaskFactory(CyServiceRegistrar sr) {	cs_registrar = sr;	}
	...
	{ 
		return new TaskIterator(new DotPlotTask(cs_registrar)); 	
	}
}