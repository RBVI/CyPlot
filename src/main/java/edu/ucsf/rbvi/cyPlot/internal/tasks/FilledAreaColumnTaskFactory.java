...
public class FilledAreaColumnTaskFactory extends AbstractTableColumnTaskFactory {
//	final CyChartManager manager;
	final CyServiceRegistrar cs_registrar;
	
	public FilledAreaColumnTaskFactory(CyServiceRegistrar sr) {	cs_registrar = sr;	}
	...
	{ 
		return new TaskIterator(new FilledAreaTask(cs_registrar)); 	
	}
}