...
public class ViolinPlotColumnTaskFactory extends AbstractTableColumnTaskFactory {
//	final CyChartManager manager;
	final CyServiceRegistrar cs_registrar;
	
	public ViolinPlotColumnTaskFactory(CyServiceRegistrar sr) {	cs_registrar = sr;	}
	...
	{ 
		return new TaskIterator(new ViolinPlotTask(cs_registrar)); 	
	}
}