...
public class HistogramPlotTaskFactory implements TaskFactory {
	CyServiceRegistrar serviceRegistrar;

	public HistogramPlotTaskFactory(CyServiceRegistrar reg) {
	...
	public TaskIterator createTaskIterator() { 
		return new TaskIterator(new HistogramPlotTask(serviceRegistrar));
	}
