...
public class GraphEditorColumnTaskFactory extends AbstractTableColumnTaskFactory {
//	final CyChartManager manager;
	final CyServiceRegistrar cs_registrar;
	
	public GraphEditorColumnTaskFactory(CyServiceRegistrar sr) {	cs_registrar = sr;	}
	...
	{ 
		return new TaskIterator(new GraphEditorTask(cs_registrar)); 	
	}
}