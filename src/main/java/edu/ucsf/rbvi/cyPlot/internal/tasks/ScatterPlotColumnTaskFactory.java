...
public class ScatterPlotColumnTaskFactory extends AbstractTableColumnTaskFactory {
//	final CyChartManager manager;
	final CyServiceRegistrar cs_registrar;
	
	public ScatterPlotColumnTaskFactory(CyServiceRegistrar sr) {	cs_registrar = sr;	}
	...
	{ 
		return new TaskIterator(new ScatterPlotTask(cs_registrar)); 	
	}
}